...
public final class PersonMsg
{
        ...
        implements PersonOrBuilder
    {
        ...
        getDescriptor()
        {
            return domain.PersonMsg.internal_static_tutorial_Person_descriptor;
        }

        protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable()
        {
            return domain.PersonMsg.internal_static_tutorial_Person_fieldAccessorTable
                .ensureFieldAccessorsInitialized(
                    domain.PersonMsg.Person.class, domain.PersonMsg.Person.Builder.class);
        }
        ...
        public static domain.PersonMsg.Person parseFrom(
        ...
        public static domain.PersonMsg.Person parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException
        {
            return PARSER.parseFrom(data);
        }
        ...
        public static domain.PersonMsg.Person parseFrom(java.io.InputStream input)
            throws java.io.IOException
        {
        ...
        public static domain.PersonMsg.Person parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException
        {
            return PARSER.parseDelimitedFrom(input);
        }

        public static domain.PersonMsg.Person parseDelimitedFrom(
            java.io.InputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException
        {
        ...
        public static Builder newBuilder(domain.PersonMsg.Person prototype)
        {
        ...
        public static final class Builder extends
            ...
            implements domain.PersonMsg.PersonOrBuilder
        {
            public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor()
            {
            ...
            // Construct using domain.PersonMsg.Person.newBuilder()
            private Builder()
            {
            ...
            public domain.PersonMsg.Person getDefaultInstanceForType()
            {
                return domain.PersonMsg.Person.getDefaultInstance();
            }

            public domain.PersonMsg.Person build()
            {
                domain.PersonMsg.Person result = buildPartial();
            ...
            public domain.PersonMsg.Person buildPartial()
            {
                domain.PersonMsg.Person result = new domain.PersonMsg.Person(this);
            ...
            {
                if (other instanceof domain.PersonMsg.Person)
                {
                    return mergeFrom((domain.PersonMsg.Person)other);
                }
                else
                {
            ...
            public Builder mergeFrom(domain.PersonMsg.Person other)
            {
                if (other == domain.PersonMsg.Person.getDefaultInstance())
                    return this;
                if (other.hasName())
                {
                    bitField0_ |= 0x00000001;
            ...
            public Builder mergeFrom(
                ...
                throws java.io.IOException
            {
                domain.PersonMsg.Person parsedMessage = null;
                try
                {
                ...
                {
                    parsedMessage = (domain.PersonMsg.Person)e.getUnfinishedMessage();
                    throw e;
                }
                finally
                {
    ...
    static
    {
        java.lang.String[] descriptorData = {
            "\n\017PersonMsg.proto\022\010tutorial\"B\n\006Person\022\014\n" +
                "\004name\030\001 \002(\t\022\n\n\002id\030\002 \002(\005\022\r\n\005email\030\003 \001(\t\022\017" +
                "\n\007friends\030\004 \003(\tB\010\n\006domain"
        };
